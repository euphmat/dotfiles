...
echo -n "mas  search : "; echo `mas search 539883307 >/dev/null 2>&1; echo $?`
...
echo -n "mas  search : "; echo `mas search 747824928 >/dev/null 2>&1; echo $?`
...
echo -n "mas search  : "; echo `mas  search 53954543534534 >/dev/null 2>&1; echo $?`
